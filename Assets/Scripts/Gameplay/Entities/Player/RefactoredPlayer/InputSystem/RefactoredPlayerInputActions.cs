...
//     version 1.6.3
//     from Assets/Scripts/Gameplay/Entities/Player/RefactoredPlayer/InputSystem/RefactoredPlayerInputActions.inputactions
//
...
namespace Spark.Gameplay.Entities.RefactoredPlayer.InputSystem
{
    public partial class @RefactoredPlayerInputActions: IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @RefactoredPlayerInputActions()
        {
            asset = InputActionAsset.FromJson(@"{
    ""name"": ""RefactoredPlayerInputActions"",
    ""maps"": [
        {
            ""name"": ""Player"",
